...
@Component({
  selector: 'app-descendant-key',
  templateUrl: './descendant-key.component.html',
  styleUrls: ['./descendant-key.component.scss']
})
export class DescendantKeyComponent implements AfterViewInit {
  ...
  onKeydown(event) {
    if (event.keyCode === ENTER) {
      this.model = this.keyManager.activeItem.item;
    } else {
